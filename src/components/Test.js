  ...
  function search() {
    var searchSunshine = sunshine.filter((val) => {
      if (searchInput.split(" ").join("") === "") {
        ...
        val.eventName.toLowerCase().includes(searchInput.toLowerCase())
      ) {
        return val;
      }
    });
          ...
          <div className="container " style={{ maxWidth: "90%" }}>
            ...
            >
              {filtersunshine.map((item) => {
                return (
                  <div
                    className="col-md-4 mx-1cont shadow "
          ...
          <div className="container" style={{ maxWidth: "90%" }}>
            ...
            >
              {filterlisoc.map((item) => {
                return (
                  <div
                    className="col-md-4 cont shadow"
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <h4
                            ...
                            style={{ fontStyle: "Roboto", fontWeight: "bold" }}
                          >
                            {item.eventName}
                          </h4>
                          <p
