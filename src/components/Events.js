...
<div class="page-content">
    ...
    <div class="card">
      <div class="content" >
        ...
        <p class="description" style={{color:"white"}}>Check out all of these gorgeous mountain trips with beautiful views of, you guessed it, the mountains</p>
          ...
          <Link to="/EventDetail/0"><button class="btn" id="0">Register</button></Link>
    ...
    <div class="card">
      <div class="content">
        ...
        <Link to="/EventDetail/1"><button class="btn" id="1">Register</button></Link>
      </div>
    </div>
    <div class="card" style={{float: "right"}}>
      <div class="content">
        ...
        <Link to="/EventDetail/2"><button class="btn" id="2">Register</button></Link>
      </div>
    </div>
    ...
    <div class="card">
      <div class="content">
        ...
        <Link to="/EventDetail/3"><button class="btn" id="3">Register</button></Link>
      </div>
    </div>
    <div class="card">
      <div class="content">
        <h2 class="heade" style={{color:"white"}}>Explore The Galaxy</h2>
        <p class="description" style={{color:"white"}}>Seriously, straight up, just blast off into outer space today</p>
        <Link to="/EventDetail/4"><button class="btn" id="4">Register</button></Link>
      </div>
    </div>
    <div class="card">
      <div class="content">
        <h2 class="heade" style={{color:"white"}}>Explore The Galaxy</h2>
        <p class="description" style={{color:"white"}}>Seriously, straight up, just blast off into outer space today</p>
        <Link to="/EventDetail/5"><button class="btn" id="5">Register</button></Link>
      </div>
    </div>
</div>
    {/* <div class="card">
