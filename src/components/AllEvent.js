...
const Allevents = () => {
  ...
  var [filterelectricalDept, setFilterelectricalDept] =
    useState(electricalDept);
  ...
  var [filtermechanicalDept, setFiltermechanicalDept] =
    useState(mechanicalDept);
  ...
  function search() {
    ...
    if (searchInput.split(" ").join("") != "") {
      ...
      if (!document.querySelector(".rs-input").placeholder)
        document.querySelector(".rs-input").placeholder = "Search";
    ...
    var searchSunshine = sunshine.filter((val) => {
      if (searchInput.split(" ").join("") === "" || searchInput === "") {
        ...
        val.society
          .toLowerCase()
          .includes(searchInput.split(" ").join("").toLowerCase())
      ) {
        // console.log(val)
        return val;
      } else if (
    ...
    <div className="bodyallevent" style={{ width: isMobile ? "100vw" : "" }}>
      ...
      {filtercentralised.length > 0 ? (
        <div>
          ...
          <div className="container " style={{ maxWidth: "90%" }}>
            ...
            >
              {filtercentralised.map((item) => {
                return (
                  <div
                    className="col-md-6 col-lg-4 col-sm-6 mx-1cont shadow p-2 rounded mb-2"
      ...
      {filterthinkbots.length > 0 ? (
        <div>
          ...
          <div className="container " style={{ maxWidth: "90%" }}>
            ...
            >
              {filterthinkbots.map((item) => {
                return (
                  <div
                    className="col-md-4 col-sm-6 cont shadow "
                    style={{ borderRadius: "5px", padding: "10px" }}
                    key={item.id}
                  >
                    <div className="my-3">
      ...
      {filtercseDept.length > 0 ? (
        <div>
          <div>
            ...
            >
              Dept. of Computer Science Engg. (CSE)
            </h2>
          </div>
          <div
            style={{
      ...
      {filtereceDept.length > 0 ? (
        <div>
          ...
          <a
            href="https://www.linkedin.com/school/electronics-communication-engineering-department-dcrust-murthal/ "
            target="_blank"
            style={{
              fontSize: "30px",
              textDecoration: "none",
