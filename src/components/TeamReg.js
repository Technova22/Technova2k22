...
const TeamReg = () => {
    ...
    if (cnt < maximumclick) {
      ...
      toaster.push(
        <Message type="info" closable>
          Team of upto {maximumclick} members allowed{" "}
        </Message>,
      );
    }
  };
  ...
  async function InsertData() {
    let dbref = ref(
      db,
      "events/" + data[ide].eventName + "/" + teamform.teamname,
    );
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <ul>
                {/* <li></li> */}
                <li>
                  All team members must be logged in once into their account to
                  register the team.
                </li>
                <br></br>
                <li>
                  All team members must be registered at once by team Leader
                  only
                </li>
                <br></br>
                <li>
                  Member 1 details will correspond to Team Leader ,who registers
                  the team.
                </li>
                <br></br>
                <li>
                  All the fields of a member are required ,otherwise the Team
      ...
      <div class={`${ide == "19" ? "d-none" : ""} rowteam`}>
        ...
        >
          <header class="headerteam ">
            ...
            >
              Member 1 should be Leader of Team and should fill details of Other
              members .
            </li>
            <li
              style={{
            ...
            <form action="" id="TeamForm">
              ...
              <div className="row">
                <span
                  className={
                    !me2
                      ? "btn btn-light fs-6 my-2 rounded-pill disabled d-none"
                      : "btn btn-light fs-6 my-2 rounded-pill animate_animated animate_slideInUp"
                  }
                  onClick={delmember}
                >
