...
export const lisoc = [
  {
    ...
    venue:
      "JCB-106&107 (15 Dec,2022 2:00pm-3:30) pmand OAT (16 Dec, 2022 8:30am-10:30am)",
    member: 4,
    eventDescription: "",
...
export const eceDept = [
  {
    ...
    venue:
      "Robotics Lab(15 December,2022 11:00AM-1:00PM) and Research Lab respectively(16 December,2022 11:00AM-1:00PM) ",
    member: 4,
    eventDescription:
  ...
  },
  {
    ...
    rules: [
      "<h4>1.Making of elephant toothpaste</h4>" +
        ...
        "<p>Requirements: Lycopodium powder, beaker, napkins </p>" +
        "<br>" +
        +"<h4>Student Coordinator and Co-coordinator:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
...
export const e_cell = [
...

  {
    ...
    rules: [
      "<ul>" +
        "<li>" +
        "speaker session by renowned entrepreneur" +
        "</li>" +
        "</ul>",
    ],
  },
