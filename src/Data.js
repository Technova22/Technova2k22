export const data = [
  {
    ...
    rules: [
      "<ul>" +
        ...
        "</ul>" +
        "<h4>Student Coordinator and Co-coordinator's:</h4>" +
        ...
        "</tr>" +
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Varsha</td>' +
        '<td style= border:"1px solid black";>9350259122</td>' +
        '<td style= border:"1px solid black";>20001003136</td>' +
        '<td style= border:"1px solid black";>raovashu4@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
...

  {
    ...
    venue:
      "JCB-106 & 107 (15 Dec,2022 2:00pm-3:pm) pm and OAT (16 Dec, 2022 8:30am-10:30am)",
    member: 1,
    eventDescription: "",
  ...
  {
    id: "3",
    eventName: "Let’s Discuss",
    society: "lisoc",
    time: "3:00PM-5:00PM and 10:30AM-11:30AM",
    date: "15 December,2022 and 16 Dec, 2022",
    venue:
      "JCB 213/214(15 December,2022 3:00PM-5:00PM) and OAT(16 Dec, 2022 10:30AM-11:30AM)",
    member: 1,
    eventDescription: "",
  ...
  },
  {
    ...
    rules: [
      "<h4>Round 1: Selfie round </h4>" +
        ...
        '<td style= border:"1px solid black";>8708590221</td>' +
        '<td style= border:"1px solid black";>19001436014</td>' +
        '<td style= border:"1px solid black";>Neharedhu2002@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    member: 2,
    eventDescription:
      "Brief description:  self made scientific model are invited for presentation",
    ...
    rules: [
      "<h4>Rules : </h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Deepak Sandhu </td>' +
        '<td style= border:"1px solid black";>9050900703</td>' +
        '<td style= border:"1px solid black";>21001551010</td>' +
        '<td style= border:"1px solid black";>Deep1293sandhu@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    rules: [
      "<h4>Poster Design &  Rules  </h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Ayushi </td>' +
        '<td style= border:"1px solid black";>9306666177</td>' +
        '<td style= border:"1px solid black";>20001436003</td>' +
        '<td style= border:"1px solid black";>tyagiayushi580@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    rules: [
      "<h4>Rules and regulations</h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Avi Gupta </td>' +
        '<td style= border:"1px solid black";>8708852541</td>' +
        '<td style= border:"1px solid black";>20001003030</td>' +
        '<td style= border:"1px solid black";>20001003030avi@dcrustm.org</td>' +
        "</tr>" +
        "</table>" +
        '<br/><a target="_blank" href="https://www.linkedin.com/school/electronics-communication-engineering-department-dcrust-murthal/">https://www.linkedin.com/school/electronics-communication-engineering-department-dcrust-murthal/ </a>',
    ],
  },

  {
    ...
    date: "16 December,2022",
    venue: "MV-311(16 December,2022 11:45am-01:45pm)",

    eventDescription:
      "a competition to test and compete your skills of designing and developing by finding solutions for the given problem statements",
    ...
    rules: [
      "<h4>Rules & Regulations:</h4>" +
        ...
        "<li><b>Round 1</b> - This round will be an idea submission round in which you will be required to submit a PPT for review of the idea or the prototype here ,the top 5 teams will move on to the next round.</li>" +
        "<li><b>Round 2 </b> – This round will be the Project explanation round </li>" +
        "<li>The theme will be released before 10 december,2022</li>" +
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "An electronics quiz which will test the skills in the field of electronics and communication engineering.Like basic circuit designing,digital system design and so on.",
  ...
  },
  {
    ...
    member: 1,
    eventDescription:
      "Proximate,i.e. to guess, is a fun event wherein students are required to guess the dimensions of some object in front of you in any unit known. Students are marked on the basis of their apt answers.",
    ...
    rules: [
      "<h4>Rules for Proximate</h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Sawesh saurav</td>' +
        '<td style= border:"1px solid black";>9525251421</td>' +
        '<td style= border:"1px solid black";>20001009052</td>' +
        '<td style= border:"1px solid black";>20001009052sawesh@dcrustm.org</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    member: 3,
    eventDescription:
      "Card tower is the old fashioned playing cards game wherein you have to make a tower using playing without letting cards fall. Students are marked on basis of the structure made and its uniqueness",
  ...
  },
  {
    ...
    society: "Electrical department ",
    time: "2pm-5pm",
    date: "15 December,2022",
    venue: "CVR112",
    member: 3,
    eventDescription:
      "It will be a one on one match. Two team contestant  of 3 players will be there. Three rounds will be there, for each one round 1 player will be selected and who makes the given circuit.",
    ...
    rules: [
      "<ul>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Tarun Kumar</td>' +
        '<td style= border:"1px solid black";>9996210741</td>' +
        '<td style= border:"1px solid black";>21001002910</td>' +
        '<td style= border:"1px solid black";>tarunkotyan@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    id: "13",
    eventName: "ARDIO CODE",
    society: "Electrical department ",
    venue: "CAD Lab (VS Block)",
    date: "16 December,2022",
    time: "08:15am-12:15pm",
    member: 1,
    eventDescription:
      "Event Date : 16/12/2022, Proposed Venues : Room no. (112,113)",
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "It is a technically startup event, where each team showcase their startup and innovative ideas infront of the jury members. The main objective of this event is to uplift the startup culture from the institute and make students to belief in creating jobs rather than seeking jobs.",
    eventImage: "/images/Event_images/tech_bhumi.jpg",
    rules: [
      "<h4>KEY-POINTS:</h4>" +
        "<ul>" +
        "<li>Maximum 4 members in a team are allowed in this event.</li>" +
  ...
  },
  {
    ...
    rules: [
      "<h4>Rules for CHEMQUIZ:</h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Jaya Chahal</td>' +
        '<td style= border:"1px solid black";>8168248316</td>' +
        '<td style= border:"1px solid black";>20001005012</td>' +
        '<td style= border:"1px solid black";>20001005012jaya@dcrustm.org</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  ...
  },
  {
    ...
    society: "Google Developer Student Club - DCRUST",
    venue: "Online",
    date: "16 December,2022",
    time: "9:00am-2:00pm",
    member: 4,
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "A treasure hunt is a game in which the organizers prepare a list defining specific items, which the participants seek to gather or complete all items on the list. It may involve following a series of clues to find objects or a single prize in a particular order.",
    eventImage: "/images/Event_images/gdsc.jpg",
    rules: [
      "<h4>Rules & Regulations:</h4>" +
        "<ul>" +
        "<li>1.All teams must have at least 1 member and no more than 4 members.</li>" +
        "<li>2.Duration: 3 hr</li>" +
        "<li>3.Scoring: The team who decodes the clue and finds the treasure first will win the game.</li>" +
        "<li>4.Do not discuss with friends, discussion is only allowed among team members.</li>" +
        "<li>5.One laptop/PC recommended for one team.</li>" +
        "<li>6.The players are allowed/encouraged to use Google (or any search engine).</li>" +
        "<li>7.Teams must stay together during the Treasure Hunt and are encouraged to work together to solve the clues and retrieve hints to advance to next levels.</li>" +
        "<li>8.Important: The rules and regulations can be changed by the event organizers without any prior notice.</li>" +
        "<br>" +
        "<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
  ...
  },
  {
    ...
    rules: [
      "<h4>Rules for THINK FUTURE Event:</h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Jyoti</td>' +
        '<td style= border:"1px solid black";>7413881942</td>' +
        '<td style= border:"1px solid black";>20001001053</td>' +
        '<td style= border:"1px solid black";>jsirohi007@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  ...
  },
  {
    ...
    society: "Department of Management Studies ",
    venue: "MBA-423",
    date: "16 December,2022",
  ...
  },
  {
    ...
    society: "1.Department of Management Studies ",
    venue: "MBA-423",
    date: "16 December,2022",
    time: "10:15am-12:15pm",
    member: 3,
  ...
  },
  {
    ...
    member: 2,
    eventDescription:
      "Any Innovative idea that can be turned into business opportunity needs to presented in this event in form of PowerPoint presentation ",
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "The objective behind organisation of Quiz competition is to check their knowledge and awareness of subject The aim of the Quiz is not just to judge the students based on their subject knowledge but also about the application of the subject matter what they have learned.",
  ...
  },
  {
    ...
    member: 2,
    eventDescription:
      "Enthralling tasks are waiting for you if you will be participating in this competition. In this, student will be given different problem statement and they will have to give an innovative idea from those statements and have to represent it in an impressive way.",
    ...
    rules: [
      "<h4>Rules and Regulation for Idea Challenge:</h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Aditi</td>' +
        '<td style= border:"1px solid black";>7419322305</td>' +
        '<td style= border:"1px solid black";>20001003011</td>' +
        '<td style= border:"1px solid black";>Sharmaditi1406@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  ...
  },
  {
    ...
    date: "15 Dec,2022 and 16 Dec,2022",
    venue:
      "MV-414(15 Dec,2022,2:00 PM-5:00 PM) and MV-415(16 Dec,2022,10:00am- 2:00pm)",
    member: 2,
    eventDescription: "",
    ...
    rules: [
      "<h4>Prelims </h4>" +
        ...
        "<h4>Mains </h4>" +
        "<h6>Selected member will be given a synopsis about a model and he/she has guide a Savera student in model making.</h6>" +
        "<br>" +
        +"<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Harshit</td>' +
        '<td style= border:"1px solid black";>8708440748</td>' +
        '<td style= border:"1px solid black";>20001001045</td>' +
        '<td style= border:"1px solid black";>8708440748y@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    society: "savera",
    time: "2:00 PM-5:00 PM and 10:00 AM-2:00 PM",
    date: "15 Dec,2022 and 16 Dec, 2022",
    venue:
      "MV-411(15 Dec,2022,2:00 PM-5:00 PM) and MV-411(16 Dec,2022,10:00 AM-2:00 PM) ",
    member: 4,
    eventDescription: "",
    ...
    rules: [
      "<h4>Prelims </h4>" +
        ...
        "<h4>Mains </h4>" +
        "<h6> The process will be same as prelims but there will be an increase in difficulty level of questions. No pen & paper will be given in this round.</h6>" +
        "<br>" +
        +"<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
  ...
  },
  {
    ...
    society: " Department of Biotechnology",
    venue: "JCB214",
    date: "16 December,2022",
    time: "9:00am-11:00am",
    member: 4,
    eventDescription:
      "This is a Bioquiz event organised by the Department of Biotechnology.In this event we will be having 3 rounds as follows.",
    ...
    rules: [
      "<h4>Round - 1 (MCQ Round)</h4>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Niharika</td>' +
        '<td style= border:"1px solid black";>7678207162</td>' +
        '<td style= border:"1px solid black";>22120013</td>' +
        '<td style= border:"1px solid black";>niharika.upadhyay00@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    rules: [
      "<h4>Rules for NUTRI BID</h4>" +
        ...
        "<li>Each team consisting of 3-4 students will have a name and representative</li>" +
  ...
  },
  {
    ...
    member: 1,
    eventDescription:
      "This is a pitch presentation event organised by the Department of Biotechnology. In this event participants are required to present a short pitch highlighting an idea from current trends emerging as a reliable solution to biotechnology and healthcare. The idea can be any interrelated technical innovation between Biotechnology and other fields like computers & softwares, robotics, semiconductors,mechanics etc.",
    eventImage: "/images/Event_images/Biogem.jpg",
    rules: [
      "<h4>Rules for BIO GEM</h4>" +
        "<ul>" +
  ...
  },
  {
    ...
    rules: [
      "<h4>Material required:</h4>" +
        ...
        "<p>Safety measurements: gloves, safety eyewear, lab coat and shoes.</p>" +
        "<br>" +
        +"<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Taneesha Rathi</td>' +
        '<td style= border:"1px solid black";>7988958987</td>' +
        '<td style= border:"1px solid black";>21001552058</td>' +
        '<td style= border:"1px solid black";>taneesharathi@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    rules: [
      "<h4>Material required:</h4>" +
        ...
        "<h6>TREASURE HUNT </h6>" +
        "<p>Secret puzzle codes related to Chemistry given at each stage. Stage is passed on first one. Kushal is the puzzle basis.</p>" +
        "<br>" +
        +"<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
  ...
  },
  {
    ...
    rules: [
      "<ul>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Pankaj Soni</td>' +
        '<td style= border:"1px solid black";>9996989633</td>' +
        '<td style= border:"1px solid black";>20001004064</td>' +
        '<td style= border:"1px solid black";>20001004064pankaj@dcrustm.org</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    rules: [
      "<ul>" +
        ...
        "<h6>Amount of requirements depends on number of entries (Approximately 50)</h6>" +
        "<br>" +
        +"<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
  ...
  },
  {
    id: "42",
    eventName: "ROBO RACE",
    time: "12:15pm-05:00pm",
    date: "15 December,2022",
    venue: "OAT",
    society: "THiNKBOTS||Robotics",
    member: 1,
    eventDescription:
      "This competition involves participant to use manually controlled bots to compete against each other and the best time through a given path to win the race.",
  ...
  },
  {
    ...
    time: "12:15pm-05:00pm",
    date: "15 December,2022",
    venue: "MV Block Ground Floor",
    society: "THiNKBOTS||Robotics",
    member: 1,
    eventDescription:
      "It’s football time and no one plays soccer better than the engineers, in their own sophisticated way we hail this event ROBO SOCCER. All you soccer fans hold your breath, as we present to you soccer with an entirely new dimension. So if you are up for the challenge get your manual soccer-playing bots ready in order to compete on the biggest stage and bring out the hidden RONALDO, MESSI in you…its time for you to stop watching soccer on screens. Participate and have lots of fun it’s going to be thrilling for sure…..enjoy the event! Organized by TH!INKBOTS under the banner of ‘TECHNOVA 2k22’.",
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "Thinker and Build requires your inner innovator to formulate solutions for a given problem in a specific time frame, the better the solution the higher your score will be. These problems will be based on the electronic circuits and basic coding challenges. So be ready to thinker and build.",
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "Showcase the best of your composition skills by using waste. After all, art is more than just pieces of paper!",
  ...
  },
  {
    ...
    member: 1,
    eventDescription:
      "It is a three round event in which eliminations will be carried out in each round. ",
  ...
  },
  {
    ...
    rules: [
      "<h6>The theme should be the main focus of the poster and should include any of the following:</h6>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Coordinator</td>' +
        '<td style= border:"1px solid black";>Tarun Jangra</td>' +
        '<td style= border:"1px solid black";>8683833906</td>' +
        '<td style= border:"1px solid black";>19001007011</td>' +
        '<td style= border:"1px solid black";>tarunjangra03@gmail.com</td>' +
        "</tr>" +
        '<tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-coodinator</td>' +
        '<td style= border:"1px solid black";>Srishti Tyagi</td>' +
        '<td style= border:"1px solid black";>8570806551</td>' +
        '<td style= border:"1px solid black";>21001007007</td>' +
        '<td style= border:"1px solid black";>tyagisrishti9@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    rules: [
      "<ul>" +
        ...
        "</ul>" +
        "<br>" +
        "<h5>Student Coordinator and Co-coordinator's:Tarun Jangra (4th year, BMED),mobile no.(8683833906)</h5>" +
        "<br>" +
  ...
  },
  {
    ...
    venue:
      "JCB220(15 December,2022 3pm-5pm) and JCB314(16 December,2022 12:30pm-2pm)",
    date: "15 December,2022 and 16 December,2022 ",
    time: "3pm-5pm and(",
    society: "BME/BIOMEDICAL",
    member: 3,
...

  {
    ...
    rules: [
      "<h4>Speaker Session by renowned Entrepreneur</h4>" +
        "<br>" +
        "<h4>Student Coordinator and Co-coordinator's:</h4>" +
        '<table class=" table " style="width:80%"; border:"1px solid black";>' +
        '<tr style= border:"1px solid black";>' +
  ...
  },
  {
    ...
    member: 1,
    eventDescription:
      "	A jenga move consists of taking one block from any level of tumble tower and replacing it on the in complete level of the tumble tower, causing the structure to grow even.",
  ...
  },
  {
    ...
    member: 4,
    eventDescription:
      "Bricks are a small unit that come together to create habitats but what more can come out of it? That is a possibility that we explore through this two-round activity. ",
  ...
  },
  {
    ...
    rules: [
      "<h3> RULES AND REGULATIONS:</h3>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Coordinator</td>' +
        '<td style= border:"1px solid black";>Ashish Joon</td>' +
        '<td style= border:"1px solid black";>9013969293	</td>' +
        '<td style= border:"1px solid black";>21001003028</td>' +
        '<td style= border:"1px solid black";>ashish29802@gmail.com</td>' +
        "</tr>" +
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Harsh Kumar</td>' +
        '<td style= border:"1px solid black";>7428842877</td>' +
        '<td style= border:"1px solid black";>20001003055</td>' +
        '<td style= border:"1px solid black";>hashurajora18@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
  {
    ...
    time: "CSE,ECE,EE,Mechanical,Civil,Chemical,BT,BME - 9:30 AM-11:30 AM  Physics, Chemistry, Mathematics, Architecture, MBA 11:30 AM-1:30 PM",
    date: "16 dec 2022",
    venue: "MV Block 2nd floor ECE department",
    society: "centralised",
    member: 1,
    eventDescription:
    ...
    rules: [
      "<h3> Who is eligible to participate?</h3>" +
        ...
        ' <tr style= border:"1px solid black";>' +
        '<td style= border:"1px solid black";>Student Co-Coordinator</td>' +
        '<td style= border:"1px solid black";>Satish Kumar</td>' +
        '<td style= border:"1px solid black";>8381824336</td>' +
        '<td style= border:"1px solid black";>20001003109</td>' +
        '<td style= border:"1px solid black";>yadavsatishkumar113@gmail.com</td>' +
        "</tr>" +
        "</table>",
    ],
  },
